...
class InterbotixGripperXSInterface(object):
    ...
    def close(self, delay=1.0):
        #override the default gripper_value
        self.left_finger_lower_limit = 0.01 #夹爪基本闭合
        self.left_finger_lower_limit = 0.015 #夹爪带触觉传感器基本闭合

        #self.left_finger_lower_limit = 0.02 #夹爪距离2cm
        self.gripper_value = 250
        #print(f'grippervalue = {self.gripper_value}')
        self.gripper_controller(-self.gripper_value, delay)
